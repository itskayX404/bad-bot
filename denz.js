...
module.exports = async (nisa, mek) => {
        ...
        const buttonMessage = { contentText: text1, footerText: desc1, buttons: but, headerType: "EMPTY" }
        nisa.sendMessage(id, buttonMessage, MessageType.buttonsMessage, options)}
	    ...
	    if (bb.includes("://chat.whatsapp.com/")) {
