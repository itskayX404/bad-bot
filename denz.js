...
const { ownerName, botName, ownerNumber, apiKey, autorespon, autoread, autojoin } = setting
...
reply(mess.success)
        ...
        case 'status':
anu = await fetchJson(`http://ip-api.com/json/?fields=country,countryCode,region,regionName,timezone,isp`, {method: 'get'})
